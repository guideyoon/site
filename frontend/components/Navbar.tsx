...
export default function Navbar({ user }: NavbarProps) {
    ...
    return (
        <>
            <nav className="bg-white dark:bg-slate-900 shadow-sm border-b border-gray-100 dark:border-slate-800 fixed w-full top-0 left-0 z-50 font-sans transition-colors duration-300">
